        ...
        <div className="d-flex align-items-center">
            <div className="mx-3">
                <span className="main-bottom-tooltip d-flex">
                    <svg id="main-sunglasses-icon" className="main-social-svg" onClick={darkMode.disable} xmlns="http://www.w3.org/2000/svg" height="1rem" viewBox="0 0 512 512">
                        <path id="Imported Path" fill="true" stroke="black" stroke-width="1"
                                d="M 264.00,480.00
