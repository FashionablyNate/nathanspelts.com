                ...
                <React.Fragment>
                    {data.allMarkdownRemark.nodes.length > 0 &&
                        <div className="card-body main-box main-color-surface my-3">
                            ...
                            <Link to={data.allMarkdownRemark.nodes[0].fields.slug} state={{ slug: data.allMarkdownRemark.nodes[0].fields.slug }} itemProp="url"><p className="card-text m-0">{data.allMarkdownRemark.nodes[0].frontmatter.title}</p></Link>
